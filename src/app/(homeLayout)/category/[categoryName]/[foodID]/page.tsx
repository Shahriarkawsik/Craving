...
const Page = async ({ params }: PageProps) => {
  ...
  const food = await getSingleFood(foodID);
  ...
  const reviews = [
    {
      ...
      review:
        "The food was absolutely delicious! Will definitely order again. The food was absolutely delicious! Will definitely order again.",
      rating: 5,
    ...
    },
    {
      ...
      review:
        "Good portion size, but the delivery was a bit late. The food was absolutely delicious! Will definitely order again.",
      rating: 4,
    ...
    },
    {
      ...
      review:
        "Tasted great but could use a bit more seasoning. The food was absolutely delicious! Will definitely order again.",
      rating: 3,
    ...
    },
    {
      ...
      review:
        "Excellent service and very tasty food! The food was absolutely delicious! Will definitely order again.",
      rating: 5,
      created_at: "2025-04-06",
    },
    {
      ...
      review:
        "Packaging was great, and the food arrived hot. The food was absolutely delicious! Will definitely order again.",
      rating: 4,
    ...
    },
    {
      ...
      review:
        "Average taste, expected something better. The food was absolutely delicious! Will definitely order again.",
      rating: 3,
      ...
      >
        <div className="w-3xl mx-auto text-center z-50">
          ...
          <p className="mt-2 text-white">
            Good food, good mood - fuel your day with flavors that make every
            bite unforgettable!
          </p>
        </div>
      </section>
      ...
      <section className="w-11/12 mx-auto">
        ...
        <div className="mt-5">
          <ul className="flex items-center justify-start font-medium list-none">
            ...
            <li className="hover:text-orange-600 mr-1">
              <Link href={`/category/${food?.category}`}>
                {food?.category} {" > "}
              </Link>
            </li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:w-3/4 mx-auto">
            ...
            <div className="space-y-4 flex flex-col">
              ...
              <div className="flex items-center text-yellow-500">
                {[...Array(5)].map((_, index) => (
                  <FaStar
                    key={index}
                    className={`mr-1 ${
                      5 >= index + 1 ? "text-yellow-500" : "text-gray-300"
                    }`}
                  />
                ))}
              ...
              <p className="text-base text-gray-700 text-justify">
                ...
                adipisicing elit. Facere, veniam aliquid! Nisi quisquam, porro
                omnis ullam iste neque aperiam illum. Ex, tenetur. Ad voluptates
                facilis nam veritatis soluta quos temporibus nihil totam, dolor
                dignissimos illo amet minus vero voluptatibus.
              </p>
              ...
              <button
                className={`mt-auto w-full text-white md:text-xl bg-orange-400 hover:bg-orange-500 flex items-center justify-center space-x-2 py-2 px-4 rounded-sm shadow-md transition-colors duration-300 ${
                  !food?.is_available
                ...
                <div key={review.id} className="flex space-x-4">
                  <div className="flex flex-col items-center justify-center">
                    <Image
                      ...
                      height={100}
                      alt={review.userName}
                      className=" rounded-full ring-2 ring-orange-500 p-1"
                    />
                  </div>
