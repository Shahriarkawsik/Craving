...
const RestaurantOwner: FC = () => {
    ...
    const getRestaurantSpecificOwner = async (): Promise<void> => {
        const specificRestaurant = await getRestaurantByEmail('shahriarkawsik@gmail.com')
            ...
            <Card className="p-4 shadow-lg bg-orange-100">
                <CardContent>
                    <div className="flex items-center space-x-4">
                        <Image src={restaurant?.restaurantLogo || restaurantLogoPublic} alt="Restaurant Logo" width={50} height={50} className="w-16 h-16 rounded-full" />
                        <div>
